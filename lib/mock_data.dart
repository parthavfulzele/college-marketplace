...
final mockListings = <Listing>[
  Listing(id: 'l1', sellerId: 'user-2', sellerName: 'Emma Wilson', sellerAvatarUrl: _avatar('EW', '3498DB'), sellerRating: 4.9,
  ...
  Listing(id: 'l2', sellerId: 'user-3', sellerName: 'Tyler Davis', sellerAvatarUrl: _avatar('TD', 'E67E22'), sellerRating: 4.5,
  ...
  Listing(id: 'l3', sellerId: 'user-4', sellerName: 'Rachel Thompson', sellerAvatarUrl: _avatar('RT', '00B894'), sellerRating: 4.7,
  ...
  Listing(id: 'l4', sellerId: 'user-5', sellerName: 'Megan Anderson', sellerAvatarUrl: _avatar('MA', 'FD79A8'), sellerRating: 5.0,
  ...
  Listing(id: 'l5', sellerId: 'user-2', sellerName: 'Emma Wilson', sellerAvatarUrl: _avatar('EW', '3498DB'), sellerRating: 4.9,
  ...
  Listing(id: 'l6', sellerId: 'user-6', sellerName: 'Brandon Carter', sellerAvatarUrl: _avatar('BC', '636E72'), sellerRating: 4.2,
  ...
  Listing(id: 'l7', sellerId: 'user-3', sellerName: 'Tyler Davis', sellerAvatarUrl: _avatar('TD', 'E67E22'), sellerRating: 4.5,
  ...
  Listing(id: 'l8', sellerId: 'user-7', sellerName: 'Ashley Morgan', sellerAvatarUrl: _avatar('AM', '00B894'), sellerRating: 4.6,
  ...
  Listing(id: 'l9', sellerId: 'user-4', sellerName: 'Rachel Thompson', sellerAvatarUrl: _avatar('RT', '00B894'), sellerRating: 4.7,
  ...
  Listing(id: 'l10', sellerId: 'user-5', sellerName: 'Megan Anderson', sellerAvatarUrl: _avatar('MA', 'FD79A8'), sellerRating: 5.0,
  ...
  Listing(id: 'l11', sellerId: 'user-6', sellerName: 'Brandon Carter', sellerAvatarUrl: _avatar('BC', '636E72'), sellerRating: 4.2,
  ...
  Listing(id: 'l12', sellerId: 'user-me', sellerName: 'Jake Mitchell', sellerAvatarUrl: _avatar('JM'), sellerRating: 4.8,
  ...
  Listing(id: 'l13', sellerId: 'user-7', sellerName: 'Ashley Morgan', sellerAvatarUrl: _avatar('AM', '00B894'), sellerRating: 4.6,
  ...
  Listing(id: 'l14', sellerId: 'user-2', sellerName: 'Emma Wilson', sellerAvatarUrl: _avatar('EW', '3498DB'), sellerRating: 4.9,
  ...
  Listing(id: 'l15', sellerId: 'user-3', sellerName: 'Tyler Davis', sellerAvatarUrl: _avatar('TD', 'E67E22'), sellerRating: 4.5,
  ...
  Listing(id: 'l16', sellerId: 'user-4', sellerName: 'Rachel Thompson', sellerAvatarUrl: _avatar('RT', '00B894'), sellerRating: 4.7,
  ...
  Listing(id: 'l17', sellerId: 'user-me', sellerName: 'Jake Mitchell', sellerAvatarUrl: _avatar('JM'), sellerRating: 4.8,
  ...
  Listing(id: 'l18', sellerId: 'user-5', sellerName: 'Megan Anderson', sellerAvatarUrl: _avatar('MA', 'FD79A8'), sellerRating: 5.0,
  ...
  Listing(id: 'l19', sellerId: 'user-6', sellerName: 'Brandon Carter', sellerAvatarUrl: _avatar('BC', '636E72'), sellerRating: 4.2,
  ...
  Listing(id: 'l20', sellerId: 'user-7', sellerName: 'Ashley Morgan', sellerAvatarUrl: _avatar('AM', '00B894'), sellerRating: 4.6,
  ...
  Listing(id: 'l21', sellerId: 'user-me', sellerName: 'Jake Mitchell', sellerAvatarUrl: _avatar('JM'), sellerRating: 4.8,
  ...
  Listing(id: 'l22', sellerId: 'user-me', sellerName: 'Jake Mitchell', sellerAvatarUrl: _avatar('JM'), sellerRating: 4.8,
...
final mockConversations = <Conversation>[
  Conversation(id: 'conv-1', otherUserId: 'user-2', otherUserName: 'Emma Wilson', otherUserAvatar: _avatar('EW', '3498DB'),
  ...
  Conversation(id: 'conv-2', otherUserId: 'user-4', otherUserName: 'Rachel Thompson', otherUserAvatar: _avatar('RT', '00B894'),
  ...
  Conversation(id: 'conv-3', otherUserId: 'user-5', otherUserName: 'Megan Anderson', otherUserAvatar: _avatar('MA', 'FD79A8'),
