...
final mockListings = <Listing>[
  ...
  Listing(id: 'l13', sellerId: 'user-7', sellerName: 'Taylor Brooks', sellerAvatarUrl: _img(206, 200, 200), sellerRating: 4.6,
    title: '2 Pacific Tigers Tickets - vs Gonzaga', description: 'Section 114, Row 22. Selling both for \$70.', price: 70, category: 'tickets', condition: 'New', images: [_img(130)], createdAt: DateTime.now().subtract(const Duration(days: 1))),
